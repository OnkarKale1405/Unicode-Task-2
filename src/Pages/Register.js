        ...
        <div id="register-comp" className="h-auto w-3/4 flex md:mt-2 justify-center m-auto p-4 md:border-black sm:border-none bg-[rgba(36, 37, 42,1)] ">
            ...
            <h1 className="md:mb-8 text-center font-bold md:text-3xl text-[#e5f0f1]">Register Now</h1>
                <div className="relative z-0 md:w-full mb-4 group">
                    ...
                    <label for="floating_full_name" className="peer-focus:font-medium absolute md:text-lg sm:text-md text-[#e5f0f1] duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#e5f0f1] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Full name</label>
                    <p className="text-sm inline-block text-red-400">{errorFullName}</p>
                </div>
                <div className="relative z-0 w-full mb-4 group">
                    <input onChange={changeMail} type="email" name="floating_email" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-[#e5f0f1] bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[rgba(0,136,169,1)] peer" placeholder=" " required />
                ...
                <div className="relative z-0 w-full mb-4 group">
                    <div>
                        <input onChange={changePass} type={showPassword ? "text" : "password"} name="floating_password" id="floating_password" className="block py-2.5 px-0 w-full text-sm text-[#e5f0f1] bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-[rgba(0,136,169,1)] peer" placeholder=" " required />
                ...
                <div className="relative z-0 w-full mb-6 group">
                    ...
                    <label for="floating_dob" className="peer-focus:font-medium absolute md:text-lg sm:text-md text-[#e5f0f1] duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#e5f0f1] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Date of birth</label>
                </div>
                <div className="relative z-0 w-full mb-6 group">
                    ...
                    <label for="floating_age" className="peer-focus:font-medium absolute md:text-lg sm:text-md text-[#e5f0f1]  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#e5f0f1] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Age</label>
                </div>

                <label for="Gender" className="block mb-2 text-xl font-medium text-[#e5f0f1] dark:text-white">Select your gender</label>
                ...
                <div className="relative z-0 w-full mb-6 group mt-6">
                    ...
                    <label for="floating_phone" className="peer-focus:font-medium absolute md:text-lg sm:text-md text-[#e5f0f1] duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#e5f0f1] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Phone number</label>
                ...
                <div className="text-center mt-12 mb-6">
                    <p className="text-[#e5f0f1]">Already a user ? <Link to="/Unicode-Task-2/login" className="uppercase text-blue-400">Login In</Link></p>
                </div>
            </form >
